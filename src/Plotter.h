...
class Plotter
{
  public:
    ...
    */
    template <typename A>
    void addTimeGraph( const char* title, int pointsDisplayed, const char* labelA, A& refA )
    {
        VariableWrapper* wrappers = new VariableWrapper[1];
        wrappers[0] =
            VariableWrapper( labelA, static_cast<void*>( &refA ), &dereference<A>, "green" );
    ...
    /*
      ...
      Args:
      - title: const char * with title of graph
      - pointsDisplayed: number of points to be shown at a given time. Determines duration of data
      persistence
    ...
    */
        ...
        Y& refY )
    {
        ...
        wrappers[0] =
            VariableWrapper( labelX, static_cast<void*>( &refX ), &dereference<X>, "green" );
        wrappers[1] =
            VariableWrapper( labelY, static_cast<void*>( &refY ), &dereference<Y>, "green" );
    ...
    */
        ...
        B& refB )
    {
        ...
        wrappers[0] =
            VariableWrapper( labelA, static_cast<void*>( &refA ), &dereference<A>, "green" );
        wrappers[1] =
            VariableWrapper( labelB, static_cast<void*>( &refB ), &dereference<B>, "orange" );
        ...
        C& refC )
    {
        ...
        wrappers[1] =
            VariableWrapper( labelB, static_cast<void*>( &refB ), &dereference<B>, "orange" );
        wrappers[2] =
            VariableWrapper( labelC, static_cast<void*>( &refC ), &dereference<C>, "cyan" );
        ...
        D& refD )
    {
        ...
        wrappers[2] =
            VariableWrapper( labelC, static_cast<void*>( &refC ), &dereference<C>, "cyan" );
        wrappers[3] =
            VariableWrapper( labelD, static_cast<void*>( &refD ), &dereference<D>, "yellow" );
        ...
        E& refE )
    {
        ...
        wrappers[3] =
            VariableWrapper( labelD, static_cast<void*>( &refD ), &dereference<D>, "yellow" );
        wrappers[4] =
            VariableWrapper( labelE, static_cast<void*>( &refE ), &dereference<E>, "pink" );
        ...
        F& refF )
    {
        ...
        wrappers[4] =
            VariableWrapper( labelE, static_cast<void*>( &refE ), &dereference<E>, "pink" );
        wrappers[5] =
            VariableWrapper( labelF, static_cast<void*>( &refF ), &dereference<F>, "blue" );
